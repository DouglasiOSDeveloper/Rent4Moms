...
export interface InventoryOverview { summary: InventorySummary; units: InventoryUnit[]; allocations: InventoryAllocation[]; movements: StockMovement[]; availability: InventoryAvailabilityEntry[] }
